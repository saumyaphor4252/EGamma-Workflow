...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Create debug ntuples for E/Gamma trigger objects from Phase2 data with Gen matching",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 makeNtuples_Phase2_GenMatched.py input.root -o output.root
  python3 makeNtuples_Phase2_GenMatched.py --output output.root input.root
  python3 makeNtuples_Phase2_GenMatched.py --max-events 100 -o output.root input.root
  python3 makeNtuples_Phase2_GenMatched.py --input-dir /path/to/files/ -o output.root
  python3 makeNtuples_Phase2_GenMatched.py --input-pattern "*.root" -o output.root
  python3 makeNtuples_Phase2_GenMatched.py --help
        """
    )
    ...
    tree = ROOT.TTree("egHLTTree", "EGamma Tree with Gen Matching")
    ...
    print("Gen matching information is stored in gen_* branches.")
