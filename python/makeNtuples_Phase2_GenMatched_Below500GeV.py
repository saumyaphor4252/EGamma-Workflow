...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python3 makeNtuples_Phase2_GenMatched_Below500GeV.py input.root -o output.root
  python3 makeNtuples_Phase2_GenMatched_Below500GeV.py --output output.root input.root
  python3 makeNtuples_Phase2_GenMatched_Below500GeV.py --max-events 100 -o output.root input.root
  python3 makeNtuples_Phase2_GenMatched_Below500GeV.py --input-dir /path/to/files/ -o output.root
  python3 makeNtuples_Phase2_GenMatched_Below500GeV.py --input-pattern "*.root" -o output.root
  python3 makeNtuples_Phase2_GenMatched_Below500GeV.py --help
        """
    )
